...
class Topo(object):
    ...
    def __init__(self, hopts=None, sopts=None, lopts=None, eopts=None):
        ...
        self.eopts = {} if eopts is None else eopts
    ...
    def addEE(self, name, **opts):
        """Convenience method: Add an EE to graph.
    ...
    def isEE(self, n):
        ...
        info = self.node_info[n]
        return info and info.get('isEE', False)
    ...
    def ees(self, sort=True):
        '''Return EEs.
        sort: sort EEs alphabetically
        @return dpids list of dpids
        '''
        return [n for n in self.nodes(sort) if self.isEE(n)]
