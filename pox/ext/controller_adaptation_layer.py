...
def _start_layer (event):
  ...
  adaptation = ControllerAdaptationAPI(
    mapped_nffg_file = init_param['mapped_nffg'])
  ...
  core.core.listen_to_dependencies(adaptation, attrs = True,
    components = getattr(adaptation, '_dependencies', ()))
