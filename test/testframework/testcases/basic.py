...
class WarningChecker(BasicErrorChecker):
  ...
  ACCEPTABLE_WARNINGS = [
    ...
    "Resource parameter cpu is not given",
    "Resource parameter mem is not given",
    "Resource parameter storage is not given",
    "Resource parameter bandwidth is not given",
